...
$TAGS = array(
	...
	'AcceptedByEntrant'	=> array('Entrant is happy!','Mark as Agreed by Entrant'),
	...
	'BonusLeg'			=> array('Available in Leg','Which leg is this bonus available. 0 = all legs'),
	...
	'BonusNavNext'		=> array('Next','Show next bonus'),
	'BonusNavPrev'		=> array('Prev','Show previous bonus'),
	'BonusNavUp'		=> array('List','Return to list of bonuses'),
	...
	'cl_PercentPenalty'	=> array('Penalty','Special penalty (percentage)'),
	...
	'OdoCheckUsed'		=> array('Tick if odo check used','Will entrants be required to ride an odometer check (calibration) route?'),	// Miles/Kms
	...
	'RptClaimsAnal'		=> array('Claims analysis','Claims analysis'),
	...
	'WizNumLegs'		=> array('Number of Legs','How many separately scored Legs will this rally consist of? Legs will need to be specified separately once this wizard is complete.'),
